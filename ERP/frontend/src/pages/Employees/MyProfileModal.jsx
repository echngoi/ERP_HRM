...
export default function MyProfileModal({ open, onClose }) {
  ...
  const renderRow = (label, value) => (
    <div style={{ display: 'flex', padding: '10px 0', borderBottom: '1px solid #f5f5f5' }}>
      <Text type="secondary" style={{ width: 160, flexShrink: 0, fontSize: 13 }}>{label}</Text>
            ...
            <>
              ...
              {hasPending && (
                <Alert
                  ...
                  message="Thông tin cập nhật của bạn đang chờ phê duyệt"
                  description="Bạn không thể gửi yêu cầu mới cho đến khi yêu cầu hiện tại được xử lý."
                  style={{ marginTop: 16 }}
                />
              )}
